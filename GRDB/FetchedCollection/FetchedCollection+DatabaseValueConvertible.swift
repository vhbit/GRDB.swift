extension FetchedCollection where Fetched: DatabaseValueConvertible {
...
extension FetchedCollection where Fetched: _OptionalFetchable, Fetched._Wrapped: DatabaseValueConvertible {
    /// Creates a fetched records controller initialized from a SQL query and
    /// its eventual arguments.
    ///
    ///     let controller = FetchedCollection<Wine>(
